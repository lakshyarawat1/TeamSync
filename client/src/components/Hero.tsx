...
const Hero = () => {
  return (
    <div className="flex bg-[#541554]">
      <div className="mx-14 my-10 w-1/2">
        ...
        <div className="text-white mt-5 w-3/4">
          ...
          rest. That’s work in Slack, your productivity platform.
              ...
              <div>
                  <button className="bg-white flex gap-5 items-center p-2 rounded-lg hover:bg-slate-100 mt-5"><FcGoogle className="text-xl" />Sign In With Google</button>
              </div>
      </div>
